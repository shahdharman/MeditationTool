...
@Composable
fun ListOfInstructorScreen(navController: NavHostController) {
    ...
    //,
        ...
        Column(modifier = Modifier.background(color = MaterialTheme.colors.surface)){
            ...
            Text(modifier = Modifier.padding(start = 20.dp), text = "Select instructor based on your comfort"
...
@Composable
fun preview(){
    ListOfInstructorScreen(navController = rememberNavController())
}